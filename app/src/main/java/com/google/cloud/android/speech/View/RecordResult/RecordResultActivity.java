...
import com.google.cloud.android.speech.databinding.LayoutActivityRecordResultBinding;
...
public class RecordResultActivity extends AppCompatActivity implements ResultHandler {
    ...
    private LayoutActivityRecordResultBinding binding;
    int pos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.layout_activity_record_result);
        ...
        mAdapter = new ResultRealmAdapter(sentenceResults, true, true);
